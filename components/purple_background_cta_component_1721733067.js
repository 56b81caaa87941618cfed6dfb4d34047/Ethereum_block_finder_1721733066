...
Vue.component("purple_background_cta_component_1721733067", {
    template: `
    <section id="cta-section-container">
        <nav class="bg-black p-4 border-b border-purple-600">
            <div class="max-w-6xl mx-auto flex justify-between items-center">
                <div class="text-purple-500 font-bold text-xl">Logo</div>
                <div class="space-x-6">
                    <a href="#" class="text-white hover:text-purple-400 transition duration-300">Home</a>
                    <a href="#" class="text-white hover:text-purple-400 transition duration-300">About</a>
                    <a href="#" class="text-white hover:text-purple-400 transition duration-300">Contact</a>
                </div>
            </div>
        </nav>
        <div id="section-container" class="max-w-6xl mx-auto px-4 sm:px-6 bg-white">
            <div id="content-container" class="relative px-8 py-12 md:py-20 rounded-[3rem] overflow-hidden">
                ...
                <div id="content" class="max-w-3xl mx-auto text-center">
                    <div id="content-subtitle" class="flex"><div id="content-subtitle-text" class="flex-1 font-medium bg-clip-text pb-3 text-transparent bg-gradient-to-r from-purple-500 to-purple-200">Unveil the Depths of the Blockchain</div></div>
                    <div class="flex" id="content-title-container"><h2 id="content-title" class="flex-1 h2 bg-clip-text pb-4 bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60"> Discover Ethereum's Latest Blocks</h2></div>
                    <div class="flex" id="content-body-container"><p id="content-body" class="flex-1 text-lg mb-8 text-slate-400">Stay ahead of the curve with our cutting-edge Ethereum block explorer. Get real-time updates on the latest blocks mined, ensuring you never miss a beat in the ever-evolving world of blockchain.</p></div>
